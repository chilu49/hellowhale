...
def getChangeString() {
	...
	def notify4(status){
		slackSend baseUrl: 'https://cabelasmobility.slack.com/services/hooks/jenkins-ci/', channel: 'newcoebb-buildstatus', color: 'good', message: 'welcome to slack testing', tokenCredentialId: 'jenkins-slack-integration-new'
